...
public class TotoLotek {
	public static void main(String[] args) {
		...
		System.out.println("Podaj 6 numerów z przedzia³u 1-50.");
...
//	liczbe co podal wczesniej lub gdy podana liczba jest w zlym zakresie
			...
			while (!poprawny) {
				try {
					...
					if (numeryUsera[i] > 50 || numeryUsera[i] < 0) {
						System.out.println("Poda³eœ numer w z³ym zakresie. Wybierz numer z zakresu 1-50");
					} else if (i!=0) {
						poprawny = true;
						for (int j=0; j<i; j++) {
		...
		System.out.println("Wybra³eœ numery: ");
		...
		if (iloscTrafien == 6) {
			System.out.println("Trafi³eœ 6!!! Mog³eœ wygraæ miliony gdyby to by³a prawdzwa gra");
		} else {
